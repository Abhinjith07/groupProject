...
class CustomAppBar extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AppBar(
      ...
      bottom: PreferredSize(preferredSize:Size.fromHeight(55),
          ...
          context.push('/search');
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                         const Icon(Ionicons.search,size: 20,color: Kolors.kPrimaryLight),
                          SizedBox(
                            width: 20.w,
                          ),
                          ReusableText(text: "Search Products",
            ...
            Container(
              ...
              child: const Icon(FontAwesome.sliders,color: Kolors.kWhite,size: 20,),
            )
              ],
            ),
            ),

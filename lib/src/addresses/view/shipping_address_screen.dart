  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: ReusableText(text: AppText.kAddresses, style: appStyle(16, Kolors.kPrimary, FontWeight.bold)),
        ),
        ...
        body: ListView(
          ...
          children: List.generate(addresses.length, (i){
            ...
            return AddressTile(
                onDelete: () {
                  context.read<AddressNotifier>().deleteAddress(address.id, refetch, context);
                },
                setDefault: () {
                 context.read<AddressNotifier>().setDefault(address.id, refetch, context);
                },
                address: address,
                isCheckout: false);
          }),

      ...
      bottomNavigationBar: Consumer<CartNotifier>(
          builder: (context,cartNotifier,child){
            ...
            context.push('/checkout');
                ...
                child:cartNotifier.selectedCartItems.isNotEmpty ? Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Padding(
                        ...
                        child: ReusableText(text: "Click To Checkout", style: appStyle(15, Kolors.kDark, FontWeight.w600)),
                      ),
                      Padding(
                          padding: const EdgeInsets.all(8.0),
                        child: ReusableText(text: "\$ ${cartNotifier.totalPrice.toStringAsFixed(2)}", style: appStyle(15, Kolors.kDark, FontWeight.w600)),
                      ),
                    ],
                  ),

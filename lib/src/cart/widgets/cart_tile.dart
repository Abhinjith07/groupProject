              ...
              child: Container(
                ...
                Column(
                  ...
                  children: [
                    ...
                    ReusableText(
                        text: 'Size:${cart.size}   ||   Color: ${cart.color}'.toUpperCase(),
                        style: appStyle(
                        ...
                        children: [
                          ...
                          : GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: ReusableText(text: "* ${cart.quantity}",
                        ...
                        ?  UpdateButton(
                            onUpdate: onUpdate,
                              ...
                              : Padding(padding: EdgeInsets.only(right:6.w),
                               child: ReusableText(text: "\$ ${(cart.quantity * cart.product.price).toStringAsFixed(2)}",

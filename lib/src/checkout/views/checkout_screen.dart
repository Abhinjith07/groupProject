...
class CheckoutPage extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return context.watch<CartNotifier>().paymentUrl.contains('https://chekout.stripe.com') ?
    const PaymentWebView(): Scaffold(
      appBar:AppBar(
          ...
          builder: (context, cartNotifier, child){
            return GestureDetector(
              onTap: () {
                if (address == null) {
                  ...
                  CreateCheckout data = CreateCheckout(
                      address: context.read<AddressNotifier>().address == null ? address.id : context.read<AddressNotifier>().address!.id,
              ...
              child: Container(
                ...
                child: Center(
                  child: ReusableText(text: address == null
                      ? "Please an Address"
                      : "Continue to Payment",
